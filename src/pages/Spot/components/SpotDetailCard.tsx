...
export function SpotDetailCard({ spot, onMoreLegend }: SpotDetailCardProps) {
  ...
  return (
    <section className="relative -mt-2 rounded-t-3xl bg-gradient-to-b from-spot-card via-spot-surface to-spot-bg px-5 pt-6 pb-5 text-center">
      ...
      <button
        ...
        className="mt-3 flex w-full items-center justify-center gap-0.5 text-sm font-medium text-secondary transition-colors hover:text-tertiary"
      >
